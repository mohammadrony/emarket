...
To install server dependencies, from `server` directory using the following command:
...
To install shop dependencies, from `shop` directory using the following command:
